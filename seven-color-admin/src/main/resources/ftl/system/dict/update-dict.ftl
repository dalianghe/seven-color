        ...
        <div style="width:100%;height:400px;overflow: auto;">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input value="${sysDictType.id}" type="hidden" name="id">
                    <input type="text" id="typeName" name="typeName" value="${sysDictType.typeName}"
                           lay-verify="typeName" autocomplete="off" class="layui-input">
                </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-inline">
                    ...
                    <div class="layui-input-inline">
                        <input type="radio" name="typeStatus" value="1" title="有效" <#if (sysDictType.typeStatus=='1')>checked</#if>>
                        <input type="radio" name="typeStatus" value="2" title="无效" <#if (sysDictType.typeStatus=='2')>checked</#if>>
                    </div>
                </div>
            </div>
            <div class="layui-form-item">
...
<script type="text/html" id="itemNameTpl">
    <input type="text" name="itemName[{{ d.LAY_INDEX }}]" style="width:100%;height: 25px;" value="{{d.itemName}}">
</script>
<script type="text/html" id="itemCodeTpl">
    <input type="text" name="itemCode[{{ d.LAY_INDEX }}]" style="width:100%;height: 25px;" value="{{d.itemCode}}">
</script>
<script type="text/html" id="itemStatusTpl">
    {{#  if(d.itemStatus == '1'){ }}
    <input type="radio" name="itemStatus[{{ d.LAY_INDEX }}]" value="1" title="有效" checked>
    <input type="radio" name="itemStatus[{{ d.LAY_INDEX }}]" value="2" title="无效">
    {{#  } else { }}
    <input type="radio" name="itemStatus[{{ d.LAY_INDEX }}]" value="1" title="有效">
    <input type="radio" name="itemStatus[{{ d.LAY_INDEX }}]" value="2" title="无效" checked>
    {{#  } }}

 </script>
<script type="text/html" id="barDemo">
    <a class="layui-btn layui-btn-danger layui-btn-xs" lay-event="del" type="button">删除</a>
</script>
...
<script>
    ...
    layui.use(['form', 'layer', 'table'], function () {
        ...
        var tableObj = table.render({
            ...
            data: tableData,
            cols: [[ //表头
                {field: 'itemName', title: '字典项', width: '23%', templet: '#itemNameTpl'}
                , {field: 'itemCode', title: '编码', width: '23%', templet: '#itemCodeTpl'}
                , {field: 'itemStatus', title: '状态', width: '35%', templet: '#itemStatusTpl'}
        ...
        $('#addItem').click(function () {
            var data = {"index": index, "itemName": "", "itemCode": "", "itemStatus": "1"};
            tableData.push(data);
