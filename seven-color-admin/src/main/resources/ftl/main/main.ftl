...
<div class="layui-layout layui-layout-admin kit-layout-admin">
    <div class="layui-header">
        <div class="layui-logo">七彩印象-后台运营系统</div>
        ...
        <div class="layui-side-scroll">
            ...
            <ul class="layui-nav layui-nav-tree" lay-filter="kitNavbar" kit-navbar>
                ...
                <li class="layui-nav-item layui-nav-itemed">
                    ...
                    <dl class="layui-nav-child">
                        <dd>
                            <a href="javascript:;" kit-target data-options="{url:'/note/noteList',icon:'&#xe62a;',title:'帖子管理',id:'1'}">
                                <i class="layui-icon">&#xe62a;</i><span> 帖子管理</span></a>
                        </dd>
                        <dd>
                            <a href="javascript:;" kit-target data-options="{url:'/comment/commentList',icon:'&#xe630;',title:'留言管理',id:'2'}">
